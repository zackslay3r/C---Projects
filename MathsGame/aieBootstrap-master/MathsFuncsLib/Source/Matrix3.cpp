...
Matrix3 Matrix3::SetRotateZ(real z)
{
	
		Matrix3 tempMatrix;

		tempMatrix.setRotateZ(z);


		return tempMatrix;
}

Matrix3 Matrix3::setScale(Vector2 scale)
{
	Matrix3 tempMatrix;
	tempMatrix[0][0] = scale.x;
	tempMatrix[1][1] = scale.y;

	return tempMatrix;
}

Matrix3 Matrix3::setPosition(Vector2 position)
{
	Matrix3 tempMatrix;
	tempMatrix[2][0] = position.x;
	tempMatrix[2][1] = position.y;
	return tempMatrix;
}


real Matrix3::getRotateZ()
{
	
		return atan2(v[0][1], v[1][1]);
